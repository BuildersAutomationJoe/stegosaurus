...
import { createDataObject } from "../graphql/mutations";
const client = generateClient();
export default function DataObjectCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createDataObject.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "DataObjectCreateForm")}
      {...rest}
    >
      <TextField
        label="Filename"
